  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { serviceSlug: 'employment-agency', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 2 },
        { serviceSlug: 'security-agency', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 3 },
        { serviceSlug: 'transport-license', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 4 },
        { serviceSlug: 'factory-license', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 5 },
        { serviceSlug: 'financial-license', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 6 },
        { serviceSlug: 'thai-fda', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 7 },
        { serviceSlug: 'visa-work-permit', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 8 },
        { serviceSlug: 'boi-promotion', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 9 },
        { serviceSlug: 'foreign-business', categorySlug: 'licensing', isPopular: false, imagePath: '', order: 10 },
      ],
    },
    {
